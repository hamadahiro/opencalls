...
const eligibilityLabel = {
  ...
  'curators': 'Curators & academics', 'scientists': 'Scientists'
};
...
function derivePrizeCategory(text) {
  ...
  if (/[$€£¥]|chf\b|sek\b|aud\b|twd\b|rub\b|nok\b|aed\b|zar\b|\br\s?\d|cash|stipend|budget|gear|camera|equipment|payment|voucher|subscription/.test(p)) return 'cash';

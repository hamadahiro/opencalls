...
function renderInfoGrid(call) {
  ...
  if (call.fee) {
    const feeHtml = call.fee.toLowerCase().startsWith('free')
      ...
      : (call.fee === 'Check website' ? 'See official website' : infoLink('/fees/entry-fee', call.fee));

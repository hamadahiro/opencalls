...
const countryPages = ["online","united-states","canada","germany","spain","japan","greece","united-kingdom","singapore","france","italy","sweden","netherlands","norway","czech-republic","portugal","hungary","ukraine","argentina","morocco","austria","northern-ireland","switzerland","south-africa","lithuania","denmark","india","brazil","ireland","australia","north-macedonia","iceland","croatia","estonia","romania","malaysia","russia","bosnia-and-herzegovina","finland","belgium","israel","united-arab-emirates","slovakia","mexico","albania","malta","qatar","poland","spain-international-applicants","south-korea","cyprus","mn","nm","ma","ct","az","ca","mi","pa","usa-open-internationally"];
const orgPages = [];

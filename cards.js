...
function renderInfoGrid(call) {
  ...
  if (call.resultsDate) {
    ...
    rows.push(infoRow(resultsPast ? 'Results' : 'Results announced', resultsPast ? esc(call.resultsDate) + ' (announced)' : esc(call.resultsDate)));
  }
  // Fee
  if (call.fee) {

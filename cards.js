...
const countryPages = ["united-kingdom","italy","united-states","spain","online","india","portugal","france","austria","czech-republic","greece","brazil","ireland","lithuania","australia","switzerland","morocco","north-macedonia","japan","germany","iceland","hungary","croatia","estonia","romania","malaysia","sweden","russia","bosnia-and-herzegovina","canada","finland","belgium","israel","netherlands","united-arab-emirates","argentina","slovakia","mexico","denmark","albania","malta","ukraine","norway"];

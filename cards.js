...
const countryPages = ["united-states","united-kingdom","singapore","online","spain","france","italy","germany","sweden","netherlands","japan","norway","czech-republic","portugal","hungary","ukraine","greece","argentina","morocco","canada","austria","northern-ireland","switzerland","south-africa","lithuania","denmark","india","brazil","ireland","australia","north-macedonia","iceland","croatia","estonia","romania","malaysia","russia","bosnia-and-herzegovina","finland","belgium","israel","united-arab-emirates","slovakia","mexico","albania","malta","qatar","poland","spain-international-applicants","south-korea","cyprus","mn","nm","ma","ct","az","ca","mi","pa","usa-open-internationally"];
const orgPages = [];
